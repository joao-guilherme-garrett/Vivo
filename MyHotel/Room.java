	...
	public Room() throws SQLException {
		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
                                    conn c = new conn();
					String displayCustomersql = "SELECT * FROM QUARTOS";
		...
		lblAvailability = new JLabel("Disponibilidade");
		lblAvailability.setBounds(119, 15, 69, 14);
		contentPane.add(lblAvailability);
		
		lblCleanStatus = new JLabel("Status de limpeza");
		...
		lblNewLabel_1 = new JLabel("Tipo de cama");
		lblNewLabel_1.setBounds(417, 15, 76, 14);
		contentPane.add(lblNewLabel_1);

		
		lblId = new JLabel("Número do quarto");
