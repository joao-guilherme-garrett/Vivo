...
public class AddDrivers extends JFrame implements ActionListener{
	...
	contentPane.setLayout(null);
        ...
        JLabel l10 = new JLabel("Adicionar Motoristas");
	...
	contentPane.add(l3);
        ...
        comboBox = new JComboBox(new String[] { "Masculino", "Feminino" });
	comboBox.setBounds(176, 150, 154, 20);
	contentPane.add(comboBox);

	JLabel l4 = new JLabel("Empresa do Carro");
	...
	contentPane.add(t3);
        ...
        JLabel l5 = new JLabel("Marca/Modelo do Carro");
	...
	contentPane.add(t4);
        ...
        JLabel l6 = new JLabel("Disponível");
	...
	contentPane.add(l6);
        ...
        comboBox_1 = new JComboBox(new String[] { "Sim", "Não" });
	comboBox_1.setBounds(176, 270, 154, 20);
	contentPane.add(comboBox_1);

        
        JLabel l7 = new JLabel("Localização");
