...
PreparedStatement pst = null;
	...
	public UpdateRoom() throws SQLException {
		...
		JLabel lblUpdateRoomStatus = new JLabel("Atualizar status do quarto");
		...
		JLabel lblNewLabel = new JLabel("ID do Hóspede :");
		...
		JLabel lblAvailability = new JLabel("Disponibilidade :");
		...
		txt_Room.setColumns(10);
                ...
                JButton b1 = new JButton("Entrar/Sair");
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                                ...
                                while(rs1.next()){
                                    txt_Room.setText(rs1.getString("numero_quarto"));    
                                }
                            }catch(Exception ee){}
                            try{
                                conn c  = new conn();
                                ResultSet rs2 = c.s.executeQuery("SELECT * FROM QUARTOS WHERE numero_qaurto = "+txt_Room.getText());
                                while(rs2.next()){
                                    txt_Ava.setText(rs2.getString("disponibilidade")); 
                                    txt_Status.setText(rs2.getString("status_limpeza"));
                                }
                            }catch(Exception ee){}
                        }
		});
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) throws NumberFormatException {
				...
				try{
                                    conn c = new conn();
                                    String str = "UPDATE QUARTOS SET status_limpeza = '"+txt_Status.getText()+"' WHERE numero_quarto = "+txt_Room.getText();
		...
		JLabel lblRoomId = new JLabel("Número do quarto :");
