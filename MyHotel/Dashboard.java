...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        super("SISTEMA DE GERENCIMENTO DO HOTEL");
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel AirlineManagementSystem = new JLabel("O GRUPO TAJ TE DÁ AS BOAS-VINDAS");
	...
	setJMenuBar(menuBar);
        ...
        JMenu AirlineSystem = new JMenu("GERÊNCIA DO HOTEL");
        AirlineSystem.setForeground(Color.BLUE);
	menuBar.add(AirlineSystem);
		
        JMenuItem FlightDetails = new JMenuItem("RECEPÇÃO");
	AirlineSystem.add(FlightDetails);
		
	JMenu AirlineSystemHello = new JMenu("ADMINISTRAÇÃO");
        AirlineSystemHello.setForeground(Color.RED);
	menuBar.add(AirlineSystemHello);
        
        JMenuItem FlightDetailshello1 = new JMenuItem("ADICIONAR FUNCIONÁRIO");
	AirlineSystemHello.add(FlightDetailshello1);
        ...
        JMenuItem FlightDetailshello2 = new JMenuItem("ADICONAR QUARTOS");
	...
	FlightDetails.addActionListener(new ActionListener(){
        ...
        JMenuItem FlightDetailshello3 = new JMenuItem("ADICIONAR MOTORISTAS");
