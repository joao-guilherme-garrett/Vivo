	...
	public CustomerInfo() throws SQLException {
		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String displayCustomersql = "SELECT * FROM CLIENTES";
		...
		lblCountry = new JLabel("País");
		lblCountry.setBounds(480, 11, 46, 14);
		contentPane.add(lblCountry);
		
		lblRoom = new JLabel("Quarto");
		lblRoom.setBounds(600, 11, 46, 14);
		contentPane.add(lblRoom);
		
		lblStatus = new JLabel("Status Check-in");
		lblStatus.setBounds(680, 11, 100, 14);
		contentPane.add(lblStatus);
		
		lblNewLabel_1 = new JLabel("Depósito");
