...
public class AddEmployee extends JFrame{
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public AddEmployee(){
            ...
            JLabel Passportno = new JLabel("NOME");
            ...
            JLabel Gender = new JLabel("GÊNERO");
            Gender.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Gender.setBounds(60, 120, 150, 27);
            add(Gender);
		
            JRadioButton NewRadioButton = new JRadioButton("MASCULINO");
            ...
            JLabel Address = new JLabel("EMPREGO");
            Address.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Address.setBounds(60, 170, 150, 27);
            add(Address);
			
            String course[] = {"Recepcionista","Portaria","Governança","Equipe de Cozinha","Serviço de Quarto","Garçon/Garçonete","Gerente","Contador","Chef"};
            c1 = new JComboBox(course);
            c1.setBackground(Color.WHITE);
            c1.setBounds(200,170,150,30);
            add(c1);
            		
            JLabel Nationality = new JLabel("SALÁRIO");
            ...
            JLabel Name = new JLabel("TELEFONE");
            ...
            JLabel AddPassengers = new JLabel("ADICIONAR DETALHES DO EMPREGADO");
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    try {
                        conn c = new conn();
                        String str = "INSERT INTO FUNCIONARIO values( '"+nome+"', '"+idade+"', '"+genero+"','"+s6+"', '"+salario+"', '"+telefone+"','"+rg+"', '"+email+"')";
