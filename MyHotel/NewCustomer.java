...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		JLabel lblName = new JLabel("NOVO FORMULÁRIO DE CLIENTE");
		...
		contentPane.add(lblId);
                ...
                comboBox = new JComboBox(new String[] {"Passaporte", "RG", "CPF", "CNH"});
		comboBox.setBounds(271, 73, 150, 20);
		contentPane.add(comboBox);
                
                JLabel l2 = new JLabel("Número :");
		...
		JLabel lblReserveRoomNumber = new JLabel("Número do quarto alocado :");
		...
		contentPane.add(lblReserveRoomNumber);
                ...
                try{
                    conn c = new conn();
                    ResultSet rs = c.s.executeQuery("SELECT * FROM QUARTOS");
                    while(rs.next()){
                        c1.add(rs.getString("numero_quarto"));    
                    }
                }catch(Exception e){ }
                c1.setBounds(271, 274, 150, 20);
		contentPane.add(c1);
		
		JLabel lblCheckInStatus = new JLabel("Check-In em:");
		lblCheckInStatus.setBounds(35, 316, 200, 14);
		contentPane.add(lblCheckInStatus);
		
		JLabel lblDeposite = new JLabel("Depósito :");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s7 =  t5.getText();
                                ...
                                String q1 = "INSERT INTO CLIENTES values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"')";
                                String q2 = "UPDATE QUARTOS SET DISPONIBILIDADE = 'Ocupado' where numero_quarto = "+s6;
	    			...
	    			System.out.println(e1.getMessage());
		    			...
		    			JOptionPane.showMessageDialog(null, "Por favor, entre com um número válido!");
			}
			}
		});
