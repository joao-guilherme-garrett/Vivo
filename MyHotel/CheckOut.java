...
public class CheckOut extends JFrame{
	...
	public CheckOut() throws SQLException {
		...
		JLabel lblName = new JLabel("Número :");
                ...
                l2.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent ae){
                        ...
                        try{
                            ...
                            ResultSet rs = c.s.executeQuery("SELECT * FROM CLIENTES where numero = "+number);
                            
                            if(rs.next()){
                                System.out.println("clicado");
                                t1.setText(rs.getString("numero_quarto"));    
                            }
                        }catch(Exception e){ }
                    }
                });
		...
		JLabel lblRoomNumber = new JLabel("Número do quarto:");
		...
		btnCheckOut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String deleteSQL = "DELETE FROM CLIENTES where numero = "+id;
                                String q2 = "UPDATE QUARTOS SET DISPONIBILIDADE = 'Disponível' where numero_quarto = "+s1;
	    		...
	    		try{
	    			...
	    			JOptionPane.showMessageDialog(null, "Check Out bem-sucedido!");
