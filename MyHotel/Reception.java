...
public class Reception extends JFrame {
	...
	public Reception(){
		...
		JButton btnNewCustomerForm = new JButton("Novo formulário de cliente");
		...
		JButton btnNewButton = new JButton("Quarto");
		...
		JButton btnNewButton_1 = new JButton("Departmento");
		...
		JButton btnNewButton_2 = new JButton("Todas as informações do funcionário");
		...
		JButton btnNewButton_3 = new JButton("Informações do cliente");
		...
		JButton btnManagerInfo = new JButton("Informações do gerente");
		...
		JButton btnNewButton_5 = new JButton("Atualizar o status de Entrada/Saída");
		...
		JButton btnNewButton_6 = new JButton("Atualizar o status do quarto");
		...
		JButton btnPickUpSerice = new JButton("Serviço de valet");
		...
		JButton btnSearchRoom = new JButton("Buscar quarto");
