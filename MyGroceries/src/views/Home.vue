      ...
      <v-row>
        <v-col cols="12">
          <v-card class="mx-auto rounded-xl" flat>
            <v-img src="cover2.png" max-height="100%" max-width="100%" contain>
              <v-card-title class="top ml-10">
                <h2 class="title1">Peça o seu</h2>
              </v-card-title>
              <v-card-title class="ml-10 mt-n8">
                <h2 class="title2">Mercadorias Diárias</h2>
              </v-card-title>
              <v-card-text class="ml-10">
                <h3 class="green--text">#Delivery Grátis</h3>
              </v-card-text>
              <v-card-text class="ml-10">
                <v-row>
                  <v-col cols="4">
                    <v-text-field
                      label="Procure suas compras diárias"
          ...
          <v-toolbar flat color="transparent">
            <v-toolbar-title class="text-h6">Categoria</v-toolbar-title>
            <v-spacer></v-spacer>
          ...
          <v-toolbar flat color="transparent" class="mt-5">
            <v-toolbar-title class="text-h6">Produto Popular</v-toolbar-title>
            <v-spacer></v-spacer>
          ...
          <v-card flat color="#E2F2E5" class="rounded-xl mt-8">
            <v-toolbar flat color="transparent" class="mb-4">
              <v-toolbar-title class="text-h6 mt-5"
                >Pacote Combo Popular</v-toolbar-title
              >
              <v-spacer></v-spacer>
            </v-toolbar>
            <Pack />
          ...
          <v-toolbar flat color="transparent" class="mt-8">
            <v-toolbar-title class="text-h6"
              >Nosso parceiro de confiança</v-toolbar-title
            >
          </v-toolbar>
          <Partner />
          <v-card
          ...
          >
            <v-row>
              ...
              <v-col cols="12" xs="12" sm="6" md="7">
                <h1 class="mt-16">Baixar o App</h1>
                <p>
