...
export default {
  data: () => ({
      bpm: 1,
    products: [
      { img: "pr1.png", title: "Repolho", subtitle: "1kg", price: "R$13" },
      { img: "pr2.png", title: "Sorvete Perry's", subtitle: "1kg", price: "R$23" },
      { img: "pr3.png", title: "Batata", subtitle: "1kg", price: "R$17" },
      { img: "pr4.png", title: "Combo Veggie", subtitle: "Batata, Mamão, Óleo, Repolho", price: "R$40" },
      { img: "pr5.png", title: "Biscoito Oreo", subtitle: "270G", price: "R$20" },
      { img: "pr6.png", title: "Mamão", subtitle: "1kg", price: "R$10" },
    ],
  }),
   methods: {
      decrement () {
