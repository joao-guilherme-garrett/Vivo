...
export default {
  data: () => ({
      bpm: 1,
    packs: [
      { img: "p1.png", title: "Caixa Média", subtitle: "Tomate, Repolho, Óleo, Couve-flor", price: "R$55" },
      { img: "p2.png", title: "Pacote Grande", subtitle: "Tomate, Repolho, Óleo, Couve-flor", price: "R$65" },
      { img: "p3.png", title: "Caixa Pequena", subtitle: "Tomate, Repolho, Óleo, Couve-flor", price: "R$45" },
      { img: "p4.png", title: "Caixa Média", subtitle: "Tomate, Repolho, Óleo, Couve-flor", price: "R$55" },
      { img: "p5.png", title: "Caixa Média", subtitle: "Tomate, Repolho, Óleo, Couve-flor", price: "R$55" },
      { img: "p6.png", title: "Caixa Média", subtitle: "Tomate, Repolho, Óleo, Couve-flor", price: "R$55" },
    ],
  }),
   methods: {
      decrement () {
